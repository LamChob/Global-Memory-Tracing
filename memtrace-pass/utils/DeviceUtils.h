...
// Device function need to in here, because the LLVM-Plugin can not access them otherwise
...
// Houst functions need to be outside, because otherwise there are linking problems
