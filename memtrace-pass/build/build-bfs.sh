...
"$cxx" -Xclang -load -Xclang $CLANGPLUGIN -Xclang -plugin \
    -Xclang cuda-aug -Xclang -plugin-arg-cuda-aug -Xclang -f -Xclang -plugin-arg-cuda-aug -Xclang ./augmented-$APPSRC3 \
    --cuda-path=$CUDASYS -std=c++11 -E $APPSRCPATH/$APPSRC3 -I$CUDASYS/samples/common/inc --cuda-gpu-arch=sm_30 -I. -I../utils
...
"$cxx" -Xclang -load -Xclang $LLVMPLUGIN --cuda-path=$CUDASYS -I$CUDASYS/samples/common/inc --cuda-gpu-arch=sm_30 -L$CUDASYS/lib64  -O1 \
 ...
 -o bfs dutils.o hutils.o augmented-bfs.o 
