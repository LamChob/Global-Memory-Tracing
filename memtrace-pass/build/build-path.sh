...
APPSRCPATH="../application/pathfinder"
APPSRC1="pathfinder.cu"
...
"$cxx" -Xclang -load -Xclang $CLANGPLUGIN -Xclang -plugin \
    -Xclang cuda-aug -Xclang -plugin-arg-cuda-aug -Xclang -f -Xclang -plugin-arg-cuda-aug -Xclang ./augmented-$APPSRC1 \
    --cuda-path=$CUDASYS -std=c++11 -E $APPSRCPATH/$APPSRC1 -I$CUDASYS/samples/common/inc --cuda-gpu-arch=sm_30 -I. -I../utils
...
"$cxx" -Xclang -load -Xclang $LLVMPLUGIN --cuda-path=$CUDASYS -I$CUDASYS/samples/common/inc --cuda-gpu-arch=sm_30 -L$CUDASYS/lib64  -O1 \
 ...
 -o pathfinder dutils.o hutils.o augmented-pathfinder.o 
