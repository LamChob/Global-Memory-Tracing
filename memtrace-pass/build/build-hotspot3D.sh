...
APPSRCPATH="../application/hotspot3D"
APPSRC2="opt1.cu"
...
"$cxx" -Xclang -load -Xclang $CLANGPLUGIN -Xclang -plugin \
    ...
    --cuda-path=$CUDASYS -Wno-writable-strings -std=c++11 -E $APPSRCPATH/$APPSRC2 -I$CUDASYS/samples/common/inc -I. -I../utils
...
# --cuda-gpu-arch=sm_30 --std=c++11 -I. -I../utils -I../application/hotspot3D/ \
#../application/hotspot3D/3D.cu  -o 3D.o
...
-lcudart_static -m64  --std=c++11 -I. -I../utils -I$APPSRCPATH  \
 ../application/hotspot3D/3D.cu -Wno-writable-strings
...
"$cxx" -Xclang -load -Xclang $LLVMPLUGIN --cuda-path=$CUDASYS -I$CUDASYS/samples/common/inc --cuda-gpu-arch=sm_30 -L$CUDASYS/lib64  -O1 \
 ...
 -o hotspot3D dutils.o hutils.o 3D.o 
